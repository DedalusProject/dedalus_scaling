"""
Dedalus script for 2.5D Rayleigh-Benard convection with MHD.
...
Equations here are solved in 2.5D, meaing that dy() terms are dropped but otherwise
the equations are the same as in 3D.
...
problem.substitutions['Bz'] = '(dx(Ay) )'
problem.substitutions['Jx'] = '( -dz(By))'
problem.substitutions['Jy'] = '(dz(Bx) - dx(Bz))'
problem.substitutions['Jz'] = '(dx(By) )'
